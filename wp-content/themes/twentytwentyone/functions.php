...
function handle_three_step_form_submission() {
    if (isset($_POST['submit_form'])) {
        ...
        $engagement_duration = isset($_POST['engagement_duration']) ? sanitize_text_field($_POST['engagement_duration']) : '';
...
add_action('init', 'handle_three_step_form_submission');

/********Create Submission menu on wordpress area********************/

function create_form_submissions_menu() {
    add_menu_page(
        'Form Submissions',
        'Form Submissions',
        'manage_options',
        'form-submissions',
        'render_form_submissions_page',
        'dashicons-feedback',
        25
    );
}
add_action('admin_menu', 'create_form_submissions_menu');

/******Render form submission values***************/

function render_form_submissions_page() {
    global $wpdb;
    $table_name = $wpdb->prefix . 'form_submissions';
    ...
    echo '<thead><tr><th>ID</th><th>Skills</th><th>Engagement Duration</th><th>Name</th><th>Email</th><th>Phone</th></tr></thead>';
    echo '<tbody>';
